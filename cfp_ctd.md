...
## Chamada para Teses e Dissertações (SSCAD-CTD)
...
- Notificação de selecionados para apresentação: 05/10/2026 (**Prorrogado**)
...
- Aplicações de Computação de Alto Desempenho em Ciências e Engenharias
...
- Ciência de Dados e Computação de Alto Desempenho
...
- Metodologias de Ensino para Arquitetura de Computadores e Alto Desempenho
...
- Validação, Verificação e Teste de Aplicações Paralelas
- Warehouse Computing
